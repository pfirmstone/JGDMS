 ...
 */
public class UserDefMatch extends UniqueEntry {
    public RandomUserDefinedClass aRUDO = null;
    ...
    /**
     * Create a new <code>UserDefMatch</code>. Passes
     ...
     */
    public UserDefMatch(boolean makeUnique) {
        super(makeUnique);
    }
}
