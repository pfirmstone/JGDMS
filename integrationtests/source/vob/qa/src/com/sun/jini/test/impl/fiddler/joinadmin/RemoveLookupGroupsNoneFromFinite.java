 ...
 * 
 * This test attempts to remove an empty set of groups represented by 
 * <code>NO_GROUPS</code> (<code>String[0]</code>) from the finite set of 
 ...
 */
public class RemoveLookupGroupsNoneFromFinite extends RemoveLookupGroups {
