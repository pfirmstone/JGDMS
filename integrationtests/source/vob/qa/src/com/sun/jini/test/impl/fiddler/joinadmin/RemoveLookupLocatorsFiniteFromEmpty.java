 ...
 *
 * This test attempts to remove a non-empty set of locators from the
 * empty set of locators with which the service is currently configured.
 *
 * @see <code>net.jini.discovery.DiscoveryLocatorManagement</code> 
 */
public class RemoveLookupLocatorsFiniteFromEmpty extends RemoveLookupLocators {
}
