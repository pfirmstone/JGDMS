 ...
 * <ul>
 * <li><code>com.sun.jini.qa.harness.rerunFailedTests</code> is a
 *     boolean flag that controls whether or not failed tests should be rerun
 * <li><code>com.sun.jini.qa.harness.testMaxRetries</code> specifies 
...
public class TestList {
    ...
    /** value of <code>com.sun.jini.qa.harness.rerunFailedTests</code> entry */
    boolean retriesEnabled;

    /** holds the value of the 
      * <code>com.sun.jini.qa.harness.testMaxRetries</code> config entry 
      */
    int maxRetries;
    ...
    public TestList(QAConfig config, long startTime) {
	    ...
	    "com.sun.jini.qa.harness.testMaxRetries", 1);
