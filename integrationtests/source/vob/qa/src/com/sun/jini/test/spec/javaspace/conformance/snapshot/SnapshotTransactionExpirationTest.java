    ...
    public void run() throws Exception {
        ...
        if (lease1 == null) {
            throw new TestException(
                    ...
                    + leaseTime1
                    + " lease time using it's snapshot within the non null"
        ...
        if (result == null) {
            throw new TestException(
                    ...
                    + " transaction using it's snapshot,"
        ...
        logDebugText(sampleEntry1.toString() + " with " + leaseTime1
                ...
                + "using their snapshots within the non null transaction.");
        ...
        if (result != null) {
            throw new TestException(
                    ...
                    + " lease time using it's snapshot, written entry is"
        ...
        if (result == null) {
            throw new TestException(
                    ...
                    + " lease time using it's snapshot, written entry"
        ...
        /*
         * write snapshot of 1-st entry twice with different finite
         * lease times within the non null transaction
         */
        lease1 = space.write(snapshot1, txn, leaseTime1);
        lease2 = space.write(snapshot1, txn, leaseTime2);
        ...
        if (lease1 == null) {
            throw new TestException(
                    "performed write within the non null transaction of "
                    + sampleEntry1 + " with " + leaseTime1
                    + " lease time using it's snapshot returned null"
                    + " lease.");
        }
        ...
        logDebugText(sampleEntry1.toString() + " with " + leaseTime1
                + " and " + leaseTime2 + " lease times using their"
                + " snapshots within the non null transaction has been"
        ...
        if (result == null) {
            throw new TestException(
                    ...
                    + "using their snapshots, there are no entries"
                    + " available in the space after " + leaseTime1
                    + " ms, while 1 is expected.");
        }
        result = (SimpleEntry) space.takeIfExists(sampleEntry1, txn,
	        JavaSpace.NO_WAIT);
        ...
        if (result != null) {
            throw new TestException(
                    ...
                    + sampleEntry1 + " with " + leaseTime1 + " and "
                    + leaseTime2 + " lease times"
                    + "using their snapshots, there are 2 entries"
                    + " available in the space after " + leaseTime1
                    + " ms, while 1 is expected.");
        }
        logDebugText("Expiration for written " + sampleEntry1 + " with "
         ...
         * finite lease times within the non null transaction again
         */
        lease1 = space.write(snapshot1, txn, leaseTime1);
        lease2 = space.write(snapshot1, txn, leaseTime2);
        ...
        logDebugText(sampleEntry1.toString() + " with " + leaseTime1
                ...
                + " transaction using their snapshots have been"
                + " successfully written to the space.");
        ...
        if (result != null) {
            throw new TestException(
                    "performed 2 writes within the non null transaction of "
                    + sampleEntry1 + " with " + leaseTime1 + " and "
                    + leaseTime2 + " lease times using their snapshots"
