 ...
 * configured to discover a set of lookup services through a MIX of group
 * discovery and locator discovery, the lookup discovery manager will send
 * a discovered event - with the appropriate contents - to that listener for
 * each lookup service that satisfies the discovery criteria.
 *
