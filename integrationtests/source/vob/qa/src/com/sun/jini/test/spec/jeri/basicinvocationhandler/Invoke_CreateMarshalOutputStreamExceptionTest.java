 ...
 *   BasicInvocationHandler.createMarshalOutputStream
 *
 * Test Cases
 ...
 *          -overloaded createMarshalOutputStream
 *           throws createMarshalOutputStreamException
 *
 * Actions
 ...
 *     6) invoke 
 *        FakeBasicInvocationHandler.setCreateMarshalOutputStreamException
 *        passing in createMarshalOutputStreamException
 *     7) invoke the method on the dynamic proxy
 *     8) assert FakeOutboundRequest request stream contains two 0x00 bytes
 *        and createMarshalOutputStreamException is thrown directly or
 *        appropriately wrapped
 * </pre>
 */
public class Invoke_CreateMarshalOutputStreamExceptionTest 
    extends AbstractInvokeTest 
{
    ...
    public void run() throws Exception {
        ...
        for (int i = 0; i < cases.length; i++) {
            ...
            iterator.init();
            handler.setCreateMarshalOutputStreamException(
                createMarshalOutputStreamException);
