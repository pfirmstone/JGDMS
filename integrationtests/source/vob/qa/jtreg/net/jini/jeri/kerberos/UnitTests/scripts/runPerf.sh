...
#     -Xbootclasspath/p:/net/jini/files6/xjiang/ws/davis/build/lib \

set -ex

if [ "$1" = -c ]
then
javac -classpath .:../../../../../unittestlib -d classes TestPerformance.java
fi
...
java -Djava.security.manager= \
     ...
     -classpath classes TestPerformance 10 20
