 ...
 * <code>com.sun.jini.qa.harness.skipConfigs</code> property to
...
public class SkipConfigTestVerifier implements ConfigurationVerifier {
     ...
     * <code>com.sun.jini.qa.harness.skipConfigs</code> property.
     * <p>
     *
	...
	String[] configList = config.parseString(
	    config.getStringConfigVal("com.sun.jini.qa.harness.skipConfigs",""),
	    " ,");
