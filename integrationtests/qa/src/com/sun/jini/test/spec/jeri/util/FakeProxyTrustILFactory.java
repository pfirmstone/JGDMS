 ...
 */
public class FakeProxyTrustILFactory extends ProxyTrustILFactory {

    public FakeProxyTrustILFactory() {
        super(null,null);
    }

    public Class[] getRemoteInterfaces(Remote impl) throws ExportException {
