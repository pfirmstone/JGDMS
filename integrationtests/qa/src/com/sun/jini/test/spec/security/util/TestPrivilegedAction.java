...
public class TestPrivilegedAction implements PrivilegedAction {
     ...
     */
    public TestPrivilegedAction(Permission perm) {
        this.perm = perm;
    }

    /**
     * Gets current DomainCombiner and stores it.
     * Calls SecurityManager.checkPermission method with stored permission and
     * stores result of this call.
     *
     * @return test object
     */
    public Object run() {
