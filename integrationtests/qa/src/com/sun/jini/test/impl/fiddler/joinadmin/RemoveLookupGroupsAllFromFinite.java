 ...
 * 
 * This test attempts to remove a set of groups represented by 
 * <code>ALL_GROUPS</code> (<code>null</code>) from the finite set of 
 * groups with which the service is configured.
 * 
 ...
 * 
 * @see <code>com.sun.jini.test.impl.fiddler.joinadmin.RemoveLookupGroups</code> 
 *
 * @see <code>net.jini.discovery.DiscoveryGroupManagement</code> 
 */
public class RemoveLookupGroupsAllFromFinite extends RemoveLookupGroups {
     ...
     *  3. Because ALL_GROUPS ( <code>null</code>) is being removed, a 
     *     <code>NullPointerException</code> is expected (refer to the
     *     DiscoveryGroupManagement specification). Verify that the
