...
public class RestoreContext implements Runnable {

    static class Action implements PrivilegedAction {
	public Object run() {
	    return AccessController.doPrivileged(
		GetContextTest.securityContext.wrap(
                        GetContextTest.checkContextAction),
		GetContextTest.securityContext.getAccessControlContext());
	}
    }
