 ...
 * that if the <code>addLocators</code> method is invoked
 ...
 *        discovery utility, the addLocators method is invoked
 * </ul><p>
 * 
 * If the <code>LookupLocatorDiscovery</code> utility functions as intended,
 * upon invoking the <code>addLocators</code> method after the
 * that utility has been terminated, an <code>IllegalStateException</code>
 * will occur.
 *
 */
public class AddLocatorsAfterTerminate
