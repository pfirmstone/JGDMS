 ...
 *
 * This test attempts to retrieve a set of groups from a service that is
 * initially configured with a set of groups that included multiple names
 * in which one of the strings is the string "none" which translates to 
 * <code>NO_GROUPS</code> (<code>String[0]</code>), but which contains
 * no elements represented by <code>ALL_GROUPS</code> (<code>null</code>).
 *
 * Note that this test class is a sub-class of the <code>GetLookupGroups</code>
 ...
 * 
 * @see <code>com.sun.jini.test.impl.fiddler.joinadmin.GetLookupGroups</code> 
 *
 * @see <code>net.jini.discovery.DiscoveryGroupManagement</code> 
 */
public class GetLookupGroupsNoneFinite extends GetLookupGroups {
}
