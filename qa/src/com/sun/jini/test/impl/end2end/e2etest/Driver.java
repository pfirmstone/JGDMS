...
public class Driver implements LegacyTest {
    ...
    private static final Logger log = Logger.getLogger("com.sun.jini.test.impl."
    ...
    public Test construct(QAConfig config) throws Exception {
        ...
        String props = config.getStringConfigVal(
            "com.sun.jini.test.impl.end2end.properties",null);
     ...
     * <code>com.sun.jini.test.impl.end2end.e2etest.End2EndTest</code>
    ...
    private void initializeKerberos() throws Exception {
        String command = config.getStringConfigVal(
            "com.sun.jini.test.impl.end2end.kinit",null);
        log.fine(command);
        Process p = Runtime.getRuntime().exec(command);
