 ...
 * that if the <code>getDiscoveredLocators</code> method is invoked
 ...
 *        discovery utility, the getDiscoveredLocators method is invoked
 * </ul><p>
 * 
 * If the <code>LookupLocatorDiscovery</code> utility functions as intended,
 * upon invoking the <code>getDiscoveredLocators</code> method after the
 * that utility has been terminated, an <code>IllegalStateException</code>
 * will occur.
 *
 */
public class GetDiscoveredLocatorsAfterTerminate
