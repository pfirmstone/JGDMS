 ...
 * that if the <code>getRegistrars</code> method is invoked
 ...
 *        discovery utility, the getRegistrars method is invoked
 * </ul><p>
 * 
 * If the <code>LookupLocatorDiscovery</code> utility functions as intended,
 * upon invoking the <code>getRegistrars</code> method after the
 * that utility has been terminated, an <code>IllegalStateException</code>
 * will occur.
 *
 */
public class GetRegistrarsAfterTerminate
