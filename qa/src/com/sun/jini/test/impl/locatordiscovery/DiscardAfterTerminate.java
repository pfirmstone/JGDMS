 ...
 * that if the <code>discard</code> method is invoked
 ...
 *        discovery utility, the discard method is invoked
 * </ul><p>
 * 
 * If the <code>LookupLocatorDiscovery</code> utility functions as intended,
 * upon invoking the <code>discard</code> method after the
 * that utility has been terminated, an <code>IllegalStateException</code>
 * will occur.
 *
 */
public class DiscardAfterTerminate extends AddDiscoveryListenerAfterTerminate {
