 ...
 * that if the <code>removeGroups</code> method is invoked
 ...
 *        the removeGroups method is invoked
 * </ul><p>
 * 
 * If the <code>LookupDiscovery</code> utility functions as intended,
 * upon invoking the <code>removeGroups</code> method after the
 * that utility has been terminated, an <code>IllegalStateException</code>
 * will occur.
 *
 */
public class RemoveGroupsAfterTerminate
