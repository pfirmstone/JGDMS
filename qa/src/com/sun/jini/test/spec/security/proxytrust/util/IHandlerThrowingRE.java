...
/**
 * Invocation handler whose 'getProxyTrustIterator' method returns
 * TrustIteratorThrowingRE.
 */
public class IHandlerThrowingRE extends NonProxyObjectThrowingRE
     ...
     */
    public IHandlerThrowingRE(Object impl) {
        super();
        this.impl = impl;
    }
