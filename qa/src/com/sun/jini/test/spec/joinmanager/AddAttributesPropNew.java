 ...
 * that may be started after the service's attributes have been augmented.
 * 
 */
public class AddAttributesPropNew extends AddAttributesProp {

    /** Executes the current test by doing the following:
     * <p>
     *   Verifies that when the <code>addAttributes</code> method is invoked,
    ...
    public void run() throws Exception {
        ...
        /* Add attributes and verify propagation to current lookup services */
        super.run();
...
} //end class AddAttributesPropNew
