 ...
 * when the lookup discovery manager is configured to discover ALL_GROUPS;
 * and then, for each discovered lookup service, send to the client's
 * listener, the appropriate discovery event with the appropriate contents.
 *
 ...
 *         and configured to discover some of the lookups by locator discovery,
 ...
 * expected contents.
 */
public class DiscoveredAll extends Discovered {
