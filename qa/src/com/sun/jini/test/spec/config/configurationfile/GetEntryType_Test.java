...
import com.sun.jini.test.spec.config.util.InterfaceTestComponent;
import com.sun.jini.test.spec.config.util.AbstractTestComponent;
 ...
 *        };
 *      call getEntryType method from this object passing
 *      "com.sun.jini.#%^&" as component and "entry" as name arguments;
