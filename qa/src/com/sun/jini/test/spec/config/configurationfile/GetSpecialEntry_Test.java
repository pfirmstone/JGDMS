 ...
 *         }
 *       call getSpecialEntry method from this object passing
 ...
 * </pre>
 */
public class GetSpecialEntry_Test extends Template_Test {
    ...
    public void runSubCase(Object testCase, Object testSubCase)
        ...
        FakeConfigurationFile configurationFile = createCF(
                ...
                null);
        try {
            configurationFile.getSpecialEntry("entry");
        ...
        // 2 - null case
        try {
            configurationFile.getSpecialEntry(null);
            throw new TestException(
                "NoSuchEntryException should be thrown");
        } catch (NoSuchEntryException ignore) {
        }
