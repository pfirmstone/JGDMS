...
public class GetEntryNames_Test extends Template_Test {
    ...
    Object[] [] testActions = new Object[] [] {
        {     "import com.sun.jini.test.spec.config.util.TestComponent;\n"
            ...
            + "}\n",
            new Integer(1),
            "com.sun.jini.test.spec.config.util.TestComponent.entry1",
            "com.sun.jini.test.spec.config.util.TestComponent.entry2"
        },
        {     "import com.sun.jini.test.spec.config.util.TestComponent;\n"
            + "com.sun.jini.test.spec.config.util.TestComponent {\n"
            + "    entry1 = new TestComponent();\n"
            ...
            new Integer(1),
            "com.sun.jini.test.spec.config.util.TestComponent.entry1",
            "com.sun.jini.test.spec.config.util.DefaultTestComponent.entry2"
        },
        {     "import com.sun.jini.test.spec.config.util.TestComponent;\n"
            + "com.sun.jini.test.spec.config.util.TestComponent {\n"
            + "    entry1 = new TestComponent();\n"
        ...
        {     "import com.sun.jini.test.spec.config.util.TestComponent;\n"
            ...
            "com.sun.jini.test.spec.config.util.TestComponent.entry1",
            "com.sun.jini.test.spec.config.util.DefaultTestComponent.entry2",
            "com.sun.jini.test.spec.config.util.TestComponent.entry3"
        }
    };
    ...
    public void runSubCase(Object testCase, Object testSubCase)
        ...
        for (int j = 0; j < testActions.length; ++j) {
            ...
            String entryOverride =
                    "com.sun.jini.test.spec.config.util.TestComponent.entry5";
