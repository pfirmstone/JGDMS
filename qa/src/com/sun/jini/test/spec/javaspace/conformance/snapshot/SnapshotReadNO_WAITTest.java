...
public class SnapshotReadNO_WAITTest extends SnapshotReadTestBase {
    ...
    public void run() throws Exception {
         ...
         */
        msg = testTemplate(sampleEntry1, null, JavaSpace.NO_WAIT, 0, false);
        ...
        msg = testWrongTemplate(template, null, JavaSpace.NO_WAIT, 0,
                false);
         ...
         */
        msg = testTemplate(null, null, JavaSpace.NO_WAIT, 0, false);
        ...
        msg = testTemplate(template, null, JavaSpace.NO_WAIT, 0, false);
