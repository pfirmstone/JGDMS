...
public class SnapshotReadIfExistsTest extends SnapshotAbstractReadTestBase {
    ...
    public void run() throws Exception {
        ...
        msg = testWrongTemplate(template, null, timeout1, 0, true);
        ...
        msg = testWrongTemplate(template, null, timeout2, 0, true);
         ...
         * as a template
         */
        msg = testTemplate(null, null, timeout1, 0, true);
        ...
        /*
         * readIfExists sample entries from the space using snapshots
         * of templates with null as a wildcard for different fields
         */
