        ...
        extends TransactionTest
{
     ...
     * 5) A registration made with a non-null value for txn is implicitly
     *    dropped when the space observes txn has left the active state.<br>
     * 6) Throws:
     *      TransactionException - if txn is non-null and is not usable
     *      by the space.<br>
     ...
     * @throws Exception
     */
    private void reset(Transaction txn) throws Exception {
        templates.clear();
