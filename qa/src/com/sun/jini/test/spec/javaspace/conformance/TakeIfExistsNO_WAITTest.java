 ...
 * 
 */
public class TakeIfExistsNO_WAITTest extends AbstractTakeTestBase {
    ...
    public void run() throws Exception {
        ...
        /*
         * takeIfExists 1-st entry from the space using the same one
        ...
        /*
         * takeIfExists sample entry from the space using
        ...
        msg = testTemplate(null, null, checkTime, 0, 0, true);
         ...
         */
        msg = testTemplate(null, null, JavaSpace.NO_WAIT, 0, 0, true);
        ...
        /*
         * takeIfExists sample entries from the space using templates with
         * null as a wildcard for different fields
         * and JavaSpace.NO_WAIT timeout
         */
        template = new SimpleEntry("TestEntry #1", null);
        msg = testTemplate(template, null, JavaSpace.NO_WAIT, 0, 0, true);
