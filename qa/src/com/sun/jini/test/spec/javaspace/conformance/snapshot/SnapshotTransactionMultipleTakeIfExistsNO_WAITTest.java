...
public class SnapshotTransactionMultipleTakeIfExistsNO_WAITTest
    ...
    public void run() throws Exception {
        ...
        /*
         * TakeIfExists entry from the space using snapshot of null as a
         ...
         * with 1-st null field and JavaSpace.NO_WAIT timeout within the
        ...
        /*
         * TakeIfExists entry from the space using snapshot of template
         * with 2-nd null field and JavaSpace.NO_WAIT timeout within the
         * transaction 4 times to take all matching written entries
         * from the space.
         */
        ...
        /*
         * TakeIfExists entry from the space using snapshot of template
         * with both null fields and JavaSpace.NO_WAIT timeout within the
