 ...
 *   BasicInvocationHandler.marshalArguments
 *
 * Test Cases
 ...
 *   where marshalArgumentsException is restricted to instances of:
 *      IOException
 *      RuntimeException
 *      Error
 *
 ...
 *          -overloaded marshalArguments throws marshalArgumentsException
 *
 * Actions
 ...
 *     6) invoke FakeBasicInvocationHandler.setMarshalArgumentsException
 *        passing in marshalArgumentsException
 ...
 *        and marshalArgumentsException is thrown directly or
 *        appropriately wrapped
 * </pre>
 */
public class Invoke_MarshalArgumentsExceptionTest extends AbstractInvokeTest {
    ...
    public void run() throws Exception {
        ...
        for (int h = 0; h < deliveryStatusCases.length; h++) {  
            ...
            for (int i = 0; i < cases.length; i++) {
                ...
                handler.setMarshalArgumentsException(marshalException);
