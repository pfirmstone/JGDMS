 ...
 *  then call renewAll() on the LeaseMap. Verify the LeaseMapException by 
 *  checking its exception map.
 */
public class ExpiredLeaseMapRenew extends QATestRegistrar {
    ...
    private void doLeaseMapRenew() throws Exception
    {
	try {
	    leaseMap.renewAll();
		...
		throw new TestException("Incorrect exception map contents", e);
	}
