 ...
 * that if the <code>addGroups</code> method is invoked while the
 ...
 * invoking the <code>addGroups</code> method with an empty array or
 * a non-<code>null</code>, non-empty array, an
 * <code>UnsupportedOperationException</code> will occur.
 */
public class AddGroupsUnsupportedOperation extends Discovered {
     ...
     *         ALL_GROUPS
     *    <li> invokes addGroups, inputting a non-null, non-empty set of
     *         groups
...
}//end class AddGroupsUnsupportedOperation
