 ...
 *
 * The logger named <code>com.sun.jini.qa.harness.test</code> is used
...
public class TestDescription implements Serializable {
     ...
     * in a config file in terms of <code>com.sun.jini.qa.home</code>.
     *
    ...
    String getJVM() {
	String testJVM = 
	    config.getStringConfigVal("com.sun.jini.jdk.home", null);
        if (testJVM == null) {
     ...
     * found, the default value <code>com.sun.jini.qa.harness.MasterTest</code>
     * is returned. If this is a slave host, then the value
     * <code>com.sun.jini.qa.harness.SlaveTest</code> is returned.
     *
	...
	if (config.isMaster()) {
	    ...
	    wrapper = "com.sun.jini.qa.harness.SlaveTest";
	}
	return wrapper;
    }
