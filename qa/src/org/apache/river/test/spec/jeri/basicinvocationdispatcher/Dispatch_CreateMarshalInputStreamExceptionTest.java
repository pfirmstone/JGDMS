 ...
 *   method when createMarshalInputStream throws an exception.
 *
 * Test Cases
 ...
 *          -overloaded createMarshalInputStream method can
 ...
 *        and the properly wrapped exception createMarshalInputStreamException
 * </pre>
 */
public class Dispatch_CreateMarshalInputStreamExceptionTest 
    ...
    public void run() throws Exception {
        ...
        for (int i = 0; i < cases.length; i++) {
            ...
            checkUnmarshallingException(
                createMarshalInputStreamException,response);
        }
    }
