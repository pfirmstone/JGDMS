...
public class SnapshotTransactionWriteTakeTest extends TransactionTest {
    ...
    public void run() throws Exception {
         ...
         * using their snapshots to the space within the transaction
         */
        ...
        /*
         * take all written entries using their snapshots
         * from the space within the transaction
         */
        space.take(snapshot1, txn, checkTime);
        space.take(snapshot1, txn, checkTime);
        ...
        // take all written entries from the space within the transaction
        ...
        if (result != null) {
            throw new TestException(
                    "there is " + result + " is still available in the"
