 ...
 */
package org.apache.river.test.spec.constraint.basicmethodconstraints.methoddesc;
 ...
 *        Call getConstraints method without parameters.
 *        Assert that the same value as in argument is returned.
 *     2)   test case b) only:
 ...
 *        Call getConstraints method without parameters.
 *        Assert that the same value as in argument is returned.
 *     4) Returns ... as a non-null value.
 *      steps:
 *        Construct MethodDesc type object instance passing null for
 *        constraints, same syntactically valid method name, and same non
 *        empty array of classes as parameters if needed.
 *        Call getConstraints method without parameters.
 *        Assert that the non-null value is returned.
 *        Assert that empty Constraints is returned.
 * </pre>
 */
public class GetConstraints_Test extends Constructor_Test {
