 ...
 * to discover a number of pre-determined lookup services when the lookup
 * discovery manager is configured to discover those lookup services through
 * ONLY group discovery; and then for each discovered lookup service, send
 * to the client's listener, the appropriate discovery event with the
 ...
 * expected contents.
 */
public class GroupsDiscovered extends Discovered {
