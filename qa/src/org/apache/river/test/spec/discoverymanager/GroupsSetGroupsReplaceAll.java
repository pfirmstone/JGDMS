 ...
 * is configured to discover a set of lookup services through only group
 * discovery, and the <code>setGroups</code> method is invoked to reconfigure
 * the lookup discovery manager to discover groups in which NONE of the
 * lookups are members, the lookup discovery manager will send to the client's
 * listener, the appropriate events with the appropriate contents.
 *
 ...
 * expected contents.
 */
public class GroupsSetGroupsReplaceAll extends SetGroupsReplaceAll {
