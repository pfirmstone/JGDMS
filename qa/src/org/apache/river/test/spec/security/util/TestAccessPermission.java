 ...
 */
public class TestAccessPermission extends AccessPermission {

    /**
     * Creates an instance with the specified target name.
     *
     * @param name the target name
     * @throws rethrows any exception thrown by parent's constructor
     */
    public TestAccessPermission(String name) {
	super(name);
    }
}
