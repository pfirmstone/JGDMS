 ...
 * 'getProxyVerifier' method returns FalseTrustVerifier instance.
 */
public class FalseProxyTrust extends BaseProxyTrust {

    /**
     * Default constructor.
     */
    public FalseProxyTrust() {
        tv = new FalseTrustVerifier();
    }

    /**
     * Returns FalseTrustVerifier instance.
     *
     * @return FalseTrustVerifier instance
     */
