 ...
 * 'getProxyVerifier' method returns TrustVerifierThrowingSE instance.
 */
public class ProxyTrustThrowingSE2 extends BaseProxyTrust {

    /**
     * Returns TrustVerifierThrowingSE instance.
     *
     * @return TrustVerifierThrowingSE instance
     */
    public TrustVerifier getProxyVerifier() throws RemoteException {
        return new TrustVerifierThrowingSE();
    }
}
