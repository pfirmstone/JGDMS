...
/**
 * Invocation handler whose 'getProxyTrustIterator' method always throws
 * SecurityException.
 */
public class IHandlerThrowingSE extends NonProxyObjectThrowingSE
     ...
     */
    public IHandlerThrowingSE(Object impl) {
        super();
        this.impl = impl;
    }
