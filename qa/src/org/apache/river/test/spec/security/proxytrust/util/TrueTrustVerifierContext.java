 ...
 * getCallerContext method. 'isTrustedObject' method of this class always
 * returns true.
 */
public class TrueTrustVerifierContext extends BaseTrustVerifierContext {

    /**
     * Constructor saving array of context objects.
     */
    public TrueTrustVerifierContext(Object[] objs) {
        super(objs);
    }
    ...
    public String toString() {
        return "TrueTrustVerifierContext[" + super.toString() + "]";
    }
}
