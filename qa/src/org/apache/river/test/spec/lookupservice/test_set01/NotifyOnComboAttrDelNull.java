 ...
 */
public class NotifyOnComboAttrDelNull extends QATestRegistrar {
    ...
    protected List expectedTuples = new ArrayList(2460);
    protected List receivedTuples = new ArrayList(2460);
    protected List<ServiceEvent> evntVec = new ArrayList<ServiceEvent>(2460);
     ...
     *  (null fields) of the loaded attributes. Creates an Entry set whose
