...
public class Service06 implements Serializable,
                                  Interface02, ProxyAccessor, ServiceRegInitializer
{
    ...
    public static void serialize(PutArg arg, Service06 s) throws IOException{
        arg.put("i", s.i);
        arg.writeArgs();
    }
	...
	try {
	    ...
	    Logger.getLogger(Service06.class.getName()).log(Level.SEVERE, null, ex);
	}
    }

    public Service06(GetArg arg) throws IOException {
	i = arg.get("i", 0);
    }
