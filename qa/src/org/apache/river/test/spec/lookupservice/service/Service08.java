...
public class Service08 implements Serializable,
                                  Interface03, ProxyAccessor, ServiceRegInitializer
{
    ...
    public static void serialize(PutArg arg, Service08 s) throws IOException{
        arg.put("i", s.i);
        arg.writeArgs();
    }
	...
	try {
	    ...
	    Logger.getLogger(Service08.class.getName()).log(Level.SEVERE, null, ex);
	}
    }

    public Service08(GetArg arg) throws IOException {
	i = arg.get("i", 0);
    }
