...
public class NotifyOnComboAttrAddNull extends QATestRegistrar {
     ...
     *  the attribute classes and creates one set of non-initialized instances 
     *  (null fields) of the loaded attributes. Retrieves the proxies to 
