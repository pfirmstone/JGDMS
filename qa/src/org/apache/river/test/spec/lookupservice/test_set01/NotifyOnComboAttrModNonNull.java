...
public class NotifyOnComboAttrModNonNull extends QATestRegistrar {
    ...
    protected final List expectedTuples = new ArrayList(2850);
    protected final List receivedTuples = new ArrayList(2850);
    protected final List<ServiceEvent> evntVec = new ArrayList<ServiceEvent>(2850);
