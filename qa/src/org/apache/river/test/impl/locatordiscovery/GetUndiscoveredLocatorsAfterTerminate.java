 ...
 * that if the <code>getUndiscoveredLocators</code> method is invoked
 ...
 *        discovery utility, the getUndiscoveredLocators method is invoked
 * </ul><p>
 * 
 * If the <code>LookupLocatorDiscovery</code> utility functions as intended,
 * upon invoking the <code>getUndiscoveredLocators</code> method after the
 * that utility has been terminated, an <code>IllegalStateException</code>
 * will occur.
 *
 */
public class GetUndiscoveredLocatorsAfterTerminate
