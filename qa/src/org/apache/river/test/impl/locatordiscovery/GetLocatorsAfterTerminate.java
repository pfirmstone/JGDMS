 ...
 * that if the <code>getLocators</code> method is invoked
 ...
 *        discovery utility, the getLocators method is invoked
 * </ul><p>
 * 
 * If the <code>LookupLocatorDiscovery</code> utility functions as intended,
 * upon invoking the <code>getLocators</code> method after the
 * that utility has been terminated, an <code>IllegalStateException</code>
 * will occur.
 *
 */
public class GetLocatorsAfterTerminate
