 ...
 * returns <code>null</code> for its action set.
 */ 

public class SharedActivationPolicyPermissionActionsTest  
    extends AbstractStartBaseTest
{
	...
	SharedActivationPolicyPermission perm = 
        ...
        logger.log(Level.INFO, "Actions test");
	if (perm.getActions() != "") {
	    throw new TestException("Permission failed getActions test");
	}	
	return;
    }
}
