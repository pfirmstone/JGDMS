 ...
 * initially configured with a set of groups consisting of elements that
 * are all finite, and in which not all of the elements are unique.
 *
 ...
 */
public class GetLookupGroupsDups extends GetLookupGroups {
}
