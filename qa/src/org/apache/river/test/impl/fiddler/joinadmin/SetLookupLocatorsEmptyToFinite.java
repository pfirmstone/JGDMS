 ...
 *
 * This test attempts to replace an empty set of locators with which the
 * service is currently configured with a non-empty set of locators.
 *
 ...
 * 
 * @see <code>org.apache.river.test.impl.fiddler.joinadmin.SetLookupGroups</code> 
 *
 * @see <code>net.jini.discovery.DiscoveryLocatorManagement</code> 
 */
public class SetLookupLocatorsEmptyToFinite extends SetLookupLocators {
}
