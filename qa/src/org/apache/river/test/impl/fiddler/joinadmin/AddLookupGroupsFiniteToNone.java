 ...
 * 
 * This test attempts to add a finite set of groups to an empty set of
 * groups represented by <code>NO_GROUPS</code>.
 * 
 ...
 */
public class AddLookupGroupsFiniteToNone extends AddLookupGroups {
} 
