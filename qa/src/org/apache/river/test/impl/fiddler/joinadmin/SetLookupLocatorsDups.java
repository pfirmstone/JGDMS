 ...
 * that contains elements that duplicate at least one element of the 
 * service's initial set of locators (and may contain duplicates among its
 * own elements).
 *
 ...
 */
public class SetLookupLocatorsDups extends SetLookupLocators {
