 ...
 * current set and then attempts to delete one or more of the just-added
 * attributes.
 */
public class ModifyLookupAttributesDeleteOne extends ModifyLookupAttributes {
    ...
    Entry[] getAttributeSetTemplates() {
        return new Entry[] {new AttributesUtil.TestAttr00("BBB","BBB","BBB")};
    }
