 ...
 *
 * This test attempts to retrieve a set of locators from a service that is
 * initially configured with a set of locators consisting of elements that
 * are not all unique.
 *
 * Note that this test class is a sub-class of the test class
 * <code>GetLookupLocators</code>. That parent class performs almost
 ...
 * 
 * @see <code>org.apache.river.test.impl.fiddler.joinadmin.GetLookupLocators</code> 
 */
public class GetLookupLocatorsDups extends GetLookupLocators {
}
