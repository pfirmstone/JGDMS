 ...
 */
public class ChildOfStringMatch extends StringMatch {
    public Float aFloat = null;

    /**
     * Required public zero arg constructor Entry classes need
     */
    public ChildOfStringMatch() {}

    /**
     * Create a new <code>ChildOfStringMatch</code>. Passes
     ...
     */
    public ChildOfStringMatch(boolean makeUnique) {
        super(makeUnique);
    }
     ...
     * a JavaSpace
     */
    public ChildOfStringMatch(ChildOfStringMatch entry) {
        super(entry);
        aFloat = entry.aFloat;
    }
}
