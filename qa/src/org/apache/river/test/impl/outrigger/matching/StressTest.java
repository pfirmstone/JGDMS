...
public class StressTest extends MatchTestCore {
    ...
    protected void parse() throws Exception {
        super.parse();
        interleave = getConfig().getBooleanConfigVal("org.apache.river.test.impl.outrigger."
                + "matching.StressTest.interleave", false);
        numEntries = getConfig().getIntConfigVal("org.apache.river.test.impl.outrigger."
                + "matching.StressTest.num_entries", 1000);
        numReaders = getConfig().getIntConfigVal("org.apache.river.test.impl.outrigger."
                + "matching.StressTest.num_readers", 1);
        numWriters = getConfig().getIntConfigVal("org.apache.river.test.impl.outrigger."
                + "matching.StressTest.num_writers", 1);
        timingStats = getConfig().getBooleanConfigVal("org.apache.river.test.impl.outrigger."
                + "matching.StressTest.timing_stats", false);
        verifyingTakes = getConfig().getBooleanConfigVal("org.apache.river.test.impl."
                + "outrigger.matching.StressTest.verify_takes", false);
        debug = getConfig().getBooleanConfigVal("org.apache.river.test.impl.outrigger."
