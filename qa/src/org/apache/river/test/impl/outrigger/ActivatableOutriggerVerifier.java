 ...
 */
package org.apache.river.test.impl.outrigger;
 ...
 * if outrigger is not if type activatable
 */
public class ActivatableOutriggerVerifier implements ConfigurationVerifier {
     ...
     *
     * @return <code>false</code> if testing non-activatable outrigger
     */
	...
	if (c != null) {
		...
		logger.log(Level.INFO, 
			   "\nActivatableOutriggerVerifier configured to skip " 
			   + td.getName() + "\n");
		return false;
	    }
	}
	c = config.getStringConfigVal("net.jini.space.JavaSpace.type",
				      "activatable");
	if (!c.equals("activatable")) {
	    logger.log(Level.INFO, 
                       "\nActivatableOutriggerVerifier configured to skip " 
