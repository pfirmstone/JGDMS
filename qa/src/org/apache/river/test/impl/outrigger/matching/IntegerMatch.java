...
public class IntegerMatch extends UniqueEntry {
    ...
    /**
     * Create a new <code>IntegerMatch</code>. Passes
     ...
     */
    public IntegerMatch(boolean makeUnique) {
        super(makeUnique);
    }

    /**
     * Create a new <code>IntegerMatch</code> that can service as a
     * template to retrieve the passed IntegerMatch (or subclass) from
     * a JavaSpace
     */
    public IntegerMatch(IntegerMatch entry) {
        super(entry);
        aInt = entry.aInt;
    }
}
