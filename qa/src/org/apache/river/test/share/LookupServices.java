...
import org.apache.river.test.share.BaseQATest.LocatorGroupsPair;
import org.apache.river.test.share.BaseQATest.LookupListener;
import org.apache.river.test.spec.discoveryservice.AbstractBaseTest.LDSEventListener;
import org.apache.river.test.spec.discoveryservice.AbstractBaseTest.RegistrationInfo;
import org.apache.river.test.spec.discoveryservice.AbstractBaseTest;
import org.apache.river.test.spec.discoveryservice.AbstractBaseTest.DiscoveryStruct;
import org.apache.river.test.spec.discoveryservice.AbstractBaseTest.RegGroupsPair;
...
public class LookupServices {
    ...
    public LookupServices(QAConfig config, AdminManager manager, int fastTimeout) throws TestException{
        ...
        String regDebug = System.getProperty("org.apache.river.reggie.proxy.debug",
                                             "false");
        logger.log(Level.FINE, " org.apache.river.reggie.proxy.debug -- {0}", regDebug);
        String joinDebug = System.getProperty("org.apache.river.join.debug",
                                              "false");
        logger.log(Level.FINE, " org.apache.river.join.debug         -- {0}", joinDebug);
        String sdmDebug = System.getProperty("org.apache.river.sdm.debug","false");
        logger.log(Level.FINE, " org.apache.river.sdm.debug          -- {0}", sdmDebug);
        ...
        fastTimeout = 
            config.getIntConfigVal("org.apache.river.test.share.fastTimeout", 
                                 fastTimeout);
	...
	String simulatorName = 
	    "org.apache.river.test.services.lookupsimulator.LookupSimulatorImpl";
