 ...
 * <ul>
 * <li><code>org.apache.river.qa.harness.verifier</code> is the name of the
 ...
 * <li><code>org.apache.river.qa.harness.runCommandAfterEachTest</code> is a
 ...
 * could include the option "-org.apache.river.qa.harness.runCommandAfterEachTest ls"
...
//                if (!socket.getReuseAddress()) socket.setReuseAddress(true);
	...
	doInputBind = config.getBooleanConfigVal(
	    "org.apache.river.qa.harness.bindInput", true);
	...
	while (testList.hasMore()) {
		...
		"org.apache.river.qa.harness.verifier", null);
	...
	boolean genXml = config.getBooleanConfigVal(
	    "org.apache.river.qa.harness.generateXml", false);
	if (genXml) {
	    try {
     ...
     * <code>org.apache.river.qa.harness.generateHtml.resultLog</code> property.
     */
     ...
     * <code>org.apache.river.qa.harness.runCommandAfterEachTest.</code>  If this
    ...
    private void runCommandAfterEachTest() {
	    ...
	    "org.apache.river.qa.harness.runCommandAfterEachTest",
          null);
        try {
            if (command != null) {
	...
	boolean discardOKOutput = 
	   config.getBooleanConfigVal("org.apache.river.qa.harness.discardOKOutput",
				      false);
	TestResult testResult = null;
	Process proc = null;
...
//  	        errPipe.waitTillEmpty(10000);
     ...
     * the parameter named <code>org.apache.river.qa.harness.timeout</code>, 
       and is iterpreted
	...
	int seconds = config.getIntConfigVal("org.apache.river.qa.harness.timeout",
					     0);
