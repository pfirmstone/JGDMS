...
public class AdminManager {
     ...
     * property. However, if <code>org.apache.river.qa.harness.serviceMode<code> is defined and
     ...
     * <code>org.apache.river.qa.harness.nSecsWaitDestroy</code>. If this does
	...
	String waitProp = "org.apache.river.qa.harness.nSecsWaitDestroy";
        int nSecsWait = 
     ...
     * <code>org.apache.river.start.ServiceDestroyer.destroy</code> and 
    ...
    private void handleDestroyCode(int destroyCode) {
        switch(destroyCode) {
            ...
            case ServiceDestroyer.SERVICE_NOT_DESTROY_ADMIN:
                logger.log(Level.FINE,
                             "destroy failure - not an instance "
                             + "of org.apache.river.admin.DestroyAdmin");
                break;
    ...
    /**
     * If <code>org.apache.river.qa.harness.serviceMode</code> is defined
