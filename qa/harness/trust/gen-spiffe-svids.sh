...
#   - URI SAN:     spiffe://test.jgdms.local/svc/<service>  (lowercase)
#   - Key type:    EC P-256
...
# ----------------------------------------------------------------------------
# 3. Import test CA into JKS trust store for use with javax.net.ssl.trustStore
# ----------------------------------------------------------------------------
