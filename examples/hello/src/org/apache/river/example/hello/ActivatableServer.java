...
public class ActivatableServer extends Server {
	...
	LoginContext loginContext = (LoginContext) config.getEntry(
	    "org.apache.river.example.hello.Server", "loginContext",
	...
	String program = (String) config.getEntry(
	    "org.apache.river.example.hello.Server", "javaProgram",
	    String.class, null);

	/* Get options for Java program */
	String[] options = (String[]) config.getEntry(
	    "org.apache.river.example.hello.Server", "javaOptions", String[].class,
	    new String[0]);
	...
	String[] propValues = (String[]) config.getEntry(
	    "org.apache.river.example.hello.Server", "javaProperties",
	...
	MarshalledObject data = new MarshalledObject(
		...
		(String[]) config.getEntry(
		    "org.apache.river.example.hello.Server", "configOptions",
		    String[].class),
		createServiceID()));

	/* Get the activation system */
	ProxyPreparer actSysPreparer = (ProxyPreparer) config.getEntry(
	    "org.apache.river.example.hello.Server", "activationSystemPreparer",
	...
	ProxyPreparer actIdPreparer = (ProxyPreparer) config.getEntry(
	    "org.apache.river.example.hello.Server", "activationIdPreparer",
	    ProxyPreparer.class, new BasicProxyPreparer());
	...
	return (Exporter) config.getEntry(
	    "org.apache.river.example.hello.Server", "exporter", Exporter.class,
