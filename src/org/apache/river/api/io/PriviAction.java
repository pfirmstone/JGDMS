 ...
 * calls.
 */
class PriviAction<T> implements PrivilegedAction<T> {
     ...
     * object.
     *
     * @param object the object whose accessible flag will be set to
     * <code>true</code>
     *
     ...
     *
     * @param property the key of the system property
     * @param defaultAnswer the return value if the system property does not
     * exist
     *
