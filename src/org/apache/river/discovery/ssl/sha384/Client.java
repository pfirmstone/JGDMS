...
package org.apache.river.discovery.ssl.sha384;
...
/**
 * Implements the client side of the <code>net.jini.discovery.ssl.sha384</code>
...
public class Client extends UnicastClient {
	 ...
	 */
	ClientImpl() {
	    super("net.jini.discovery.ssl.sha384", epi);
	}
