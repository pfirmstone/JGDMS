...
public class UIDescriptor extends AbstractEntry {
     ...
     * Fields are in declaration order: role, toolkit, attributes, factory.
     *
     * @return array of wire fields
     */
    public static EntryWireField[] entryForm() {
        return new EntryWireField[] {
            new EntryWireField("role",       String.class),
            new EntryWireField("toolkit",    String.class),
            new EntryWireField("attributes", Set.class),
            new EntryWireField("factory",    MarshalledObject.class),
        };
    }
    ...
    public UIDescriptor(GetEntryArg arg) throws IOException {
        role    = arg.get("role",    null, String.class);
        toolkit = arg.get("toolkit", null, String.class);
        Set attrs = arg.get("attributes", null, Set.class);
        attributes = (attrs != null) ? new ConsistentSet(attrs) : null;
        factory = arg.get("factory", null, MarshalledObject.class);
    }
     ...
     */
    public static void serialize(PutEntryArg arg, UIDescriptor obj) throws IOException {
        arg.put("role",       obj.role);
        arg.put("toolkit",    obj.toolkit);
        arg.put("attributes", obj.attributes);
        arg.put("factory",    obj.factory);
        arg.writeArgs();
    }
    /**
