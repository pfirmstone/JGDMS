 ...
 * @since 3.1.1
 */
public interface DiscoveryCredentialProvider {

    /**
     * Returns the subject to use for outbound discovery operations.
     *
     * @return subject for discovery operations, or {@code null} to use the
     *         current call context unchanged
     */
    Subject getSubject();
}
