 ...
 * net.jini.security.Security.verifyCodebaseIntegrity}).  Whether or not a particular
    ...
    extends ObjectInputStream implements ObjectStreamContext
{
     ...
     * net.jini.security.Security#verifyCodebaseIntegrity
     * net.jini.security.Security.verifyCodebaseIntegrity} is invoked to enforce that
