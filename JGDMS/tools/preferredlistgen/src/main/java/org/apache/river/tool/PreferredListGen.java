 ...
 * files in the form of a META-INF/PREFERRED.LIST required for use by the <code>
 * net.jini.loader.pref.PreferredClassLoader</code>. The list is generated by
 ...
 * <p>
 * This tool implements the first guideline described in <code>
 * net.jini.loader.pref</code>.  In many cases it is sufficient to specify
 ...
 * application classes, classes from the JGDMS release, and any other classes on
