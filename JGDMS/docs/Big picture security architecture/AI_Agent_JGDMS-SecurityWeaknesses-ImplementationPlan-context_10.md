...
continue without loss of context. This is version 37, updated to add the Option E deep-dive
(event-sourced read replicas for Weakness 5 — VerdictRegistry outage) and Work Item 57
