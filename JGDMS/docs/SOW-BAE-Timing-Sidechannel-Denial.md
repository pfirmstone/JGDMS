...
- **Companions:** `No-SM-Permanently-Ungated-Primitives.md` (the `AttachPermission`/JMX policy-audit
  ...
  as secondary defense-in-depth (see §1a below), not superseded or made worthless.**
