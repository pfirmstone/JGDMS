 ...
 */
public class ServiceDiscoveryManagerImpl implements net.jini.lookup.ServiceDiscoveryManagerSpi {
     ...
     * @see net.jini.core.lookup.ServiceRegistrar
     */
    public ServiceDiscoveryManagerImpl(DiscoveryManagement discoveryMgr,
    ...
    private ServiceDiscoveryManagerImpl(Initializer init) {
