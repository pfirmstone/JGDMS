 ...
 */
public class JoinManagerImpl implements net.jini.lookup.JoinManagerSpi {
    ...
    private class ProxyRegTask extends RetryTask implements Comparable<ProxyRegTask> {
        ...
        ProxyRegTask(ProxyReg proxyReg, int seqN) {
            super(JoinManagerImpl.this.executor,JoinManagerImpl.this.wakeupMgr);
	...
	final ServiceRegistrar proxy;
         ...
         *  associated service.
         * 
         * Writes to reference synchronized on JoinManagerImpl.this, but not referent
	...
	public ProxyReg(ServiceRegistrar proxy) {
		...
		LogUtil.logThrow(logger, Level.WARNING, ProxyReg.class,
            ...
            synchronized (JoinManagerImpl.this){
                item = serviceItem;
     ...
     */
    private volatile ServiceItem serviceItem = null; // writes sync on JoinManagerImpl.this
     ...
     *  service.
     */
    private volatile Entry[] lookupAttr = null; // writes sync on JoinManagerImpl.this
     ...
     * @see net.jini.lease.LeaseRenewalManager
     */
     public JoinManagerImpl(Object serviceProxy,
                        Entry[] attrSets,
     ...
     */
    private JoinManagerImpl(Object serviceProxy,
