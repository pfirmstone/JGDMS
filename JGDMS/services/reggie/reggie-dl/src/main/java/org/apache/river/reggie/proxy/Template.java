...
public class Template implements Serializable {
	...
	return serviceTypes != null ? serviceTypes.clone() : null;
    }
    
    public int serviceTypesLength(){
	return serviceTypes != null? serviceTypes.length : 0;
    }
    
    public ServiceType serviceTypeAtIndex(int i){
	return serviceTypes == null ? null : serviceTypes[i];
    }
    
    public EntryRep[] attributeSetTemplates(){
	return attributeSetTemplates != null ? attributeSetTemplates.clone() : null;
    }
    
    public EntryClass attributeSetTemplType(){
	return attributeSetTemplates != null ? attributeSetTemplates[0].eclass : null;
    }
    
    public EntryRep attributeSetTemplateAtIndex(int i){
	return attributeSetTemplates[i];
    }
