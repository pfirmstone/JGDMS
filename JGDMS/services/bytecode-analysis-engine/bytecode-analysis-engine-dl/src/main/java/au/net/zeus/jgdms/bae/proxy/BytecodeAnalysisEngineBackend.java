...
/**
 * Server-side <b>backend</b> remote interface for the BytecodeAnalysisEngine
 * service — the single interface the exported server stub satisfies.
 *
 ...
 * ({@link BytecodeAnalysisEngine}) <em>and</em> every infrastructure capability
 * a JGDMS service stub must expose.  Because it extends {@link Remote}, a JERI
 * exporter generates a stub that — being a proxy for
 * {@code BytecodeAnalysisEngineBackend} — transitively implements all of the
 ...
 *
 * <p>The split mirrors Reggie: {@link BytecodeAnalysisEngine} stays clean and
 ...
 * {@code -dl} jar.  {@code ActivatableBytecodeAnalysisEngineImpl} implements
 * this interface; the infrastructure members all come from
 ...
 * @since 3.1.1
 */
public interface BytecodeAnalysisEngineBackend
        extends Remote,
