...
public class RemotePolicyServiceProxy
    ...
    /**
     * Factory method — returns a {@link ConstrainableRemotePolicyServiceProxy}
     * when {@code server} implements {@link RemoteMethodControl}, otherwise a
     * plain {@code RemotePolicyServiceProxy}.
     *
     ...
     * @param proxyID the service's stable unique identifier; must be non-null
     */
    public RemotePolicyServiceProxy(RemotePolicyService server, Uuid proxyID) {
