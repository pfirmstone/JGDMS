...
/**
 * Server-side <b>backend</b> remote interface for the VerdictRegistry service —
 ...
 * ({@link VerdictRegistry}) <em>and</em> every infrastructure capability a JGDMS
 * service stub must expose.  Because it extends {@link Remote}, a JERI exporter
 * generates a stub that — being a proxy for {@code VerdictRegistryBackend} —
 * transitively implements all of the aggregated interfaces, including the ones
 * that are not themselves {@code Remote} ({@link Administrable},
 * {@link JoinAdmin}, {@link DestroyAdmin}).  That is what lets
 ...
 *
 * <p>The split mirrors Reggie: {@link VerdictRegistry} stays clean and
 ...
 * {@code -dl} jar.  {@code ActivatableVerdictRegistryImpl} implements this
 ...
 * @since 3.1.1
 */
public interface VerdictRegistryBackend
        extends Remote,
                VerdictRegistry,
