 ...
 * {@code serialForm()}.
 *
 * <h2>S7.8 normative rule -- embedded schema is authoritative</h2>
 * <p>
...
public final class MarshalledInstanceCodec {
    ...
    /**
     * The three decoding cases from JGDMS-STD-006 S3.9.
    ...
    public enum SchemaCase {
         ...
         *
         * <p>Per S3.9, "case (b)" labels the "sender was newer" sub-case and
    ...
    public static <T> Result<T> decodeMarshalledInstance(
        ...
        // Step 3: ALWAYS decode using the embedded chain (S7.8 normative).
